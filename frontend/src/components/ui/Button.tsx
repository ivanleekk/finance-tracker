    ...
    ({ className, variant = "primary", size = "md", ...props }, ref) => {
        return (
            <button
                ref={ref}
                className={cn(
                    "inline-flex items-center justify-center shrink-0 whitespace-nowrap rounded-md font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 disabled:pointer-events-none disabled:opacity-50",
                    {
                        ...
                        // The signature gradient CTA from the design: used for the primary "+ Add"-style action on every screen.
                        "rounded-lg bg-gradient-to-br from-secondary-500 to-secondary-700 text-white hover:brightness-110 active:brightness-95": variant === "cta",
