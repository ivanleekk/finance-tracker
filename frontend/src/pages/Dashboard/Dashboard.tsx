...
export default function Dashboard() {
    ...
    const currentCash = useMemo(() => {
        ...
        Object.values(balances).forEach(history => {
            if (history.length > 0) {
                const sorted = [...history]/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a.date > b.date ? 1 : a.date < b.date ? -1 : 0);
    ...
    const currentPortfolioValue = useMemo(() => {
        ...
        const sortedDates = Object.keys(snapshotsByDate)/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a > b ? 1 : a < b ? -1 : 0);
    ...
    const chartData = useMemo(() => {
        ...
        const sortedDates = Array.from(allDatesSet)/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a > b ? 1 : a < b ? -1 : 0);
        ...
        return Array.from(binned.values())/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a.date > b.date ? 1 : a.date < b.date ? -1 : 0);
                ...
                <CardContent>
                    <div className="space-y-4">
                        {transactions.length > 0 ? (
                            transactions.slice(0, 5)/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => b.date > a.date ? 1 : b.date < a.date ? -1 : 0).map((tx) => (
