            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 print:overflow-visible print:p-0">
                <div id="printable-report" className="mx-auto max-w-3xl bg-white text-neutral-900 rounded-xl shadow-lg print:shadow-none print:rounded-none p-10 print:p-0 space-y-8">
                    ...
                    <footer className="border-t border-neutral-200 pt-3 text-[10px] text-neutral-400">
                        Balances and valuations are converted to {currency} using recorded exchange rates. Private items belonging to other household members are excluded. Generated by Waypoint.
                    </footer>
                </div>
            </div>
        </div>
