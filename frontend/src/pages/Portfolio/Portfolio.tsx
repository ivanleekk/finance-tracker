    ...
    const portfoliosData = useMemo(() => {
        ...
        const binHistory = (history: any[]) => {
            ...
            return Array.from(binned.entries())
                ...
                /* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a[0] > b[0] ? 1 : a[0] < b[0] ? -1 : 0)
        ...
        const calculateFromSnapshots = (snaps: typeof snapshots) => {
            ...
            const sortedDates = Array.from(dailyEquity.keys())/* Optimized: using standard operators instead of localeCompare for faster ISO date sorting */ .sort((a, b) => a > b ? 1 : a < b ? -1 : 0);
