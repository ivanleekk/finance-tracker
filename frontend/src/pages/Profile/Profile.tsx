                    ...
                    <CardContent className="p-2">
                        <div className="space-y-1">
                            ...
                            <button 
                                ...
                                className={cn(
                                    "w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all",
                                    activeSection === "Appearance" ? "bg-primary-50 text-primary-600 shadow-sm" : "text-base-600 hover:bg-base-50 hover:text-base-900"
                                )}
                            >
                            ...
                            <Card className="border-base-200/50 shadow-sm overflow-hidden">
                                ...
                                <CardContent className="space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-sm font-semibold text-base-900">Color Mode</label>
                                            ...
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        themeMode === mode.id 
                                                            ? "border-primary-500 bg-primary-50/50 text-primary-700 dark:bg-primary-950/30 dark:text-primary-400" 
                                                            : "border-base-100 bg-base-50/30 text-base-500 hover:border-base-200 dark:border-base-800 dark:bg-base-900/30 dark:text-base-400 dark:hover:border-base-700"
                                                    )}
                                                >
                                    ...
                                    <div className="grid gap-8 sm:grid-cols-3">
                                        {/* Primary */}
                                        <div className="space-y-4">
                                            <label className="text-sm font-semibold text-base-900">Primary Color</label>
                                        ...
                                        {/* Secondary */}
                                        <div className="space-y-4">
                                            <label className="text-sm font-semibold text-base-900">Secondary Color</label>
                                            <div className="flex flex-wrap gap-2">
                                        ...
                                        {/* Base */}
                                        <div className="space-y-4">
                                            <label className="text-sm font-semibold text-base-900">Base Neutral</label>
                                            <div className="flex flex-wrap gap-2">
